...
public class Region {
	...
	// Score for first placing the armies, at the beginning of the game
	public int getRegionScore(BotState state){
		// if the region doesn't have a bonus, put it last in queue
		if(superRegion.getArmiesReward() == 0){
			return Integer.MAX_VALUE;
		}
		return state.getArmies(superRegion) + superRegion.getSubRegions().size();
	}
